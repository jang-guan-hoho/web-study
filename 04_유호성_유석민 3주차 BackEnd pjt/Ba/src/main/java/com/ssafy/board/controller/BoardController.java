...
public class BoardController extends HttpServlet {
	...
	private void doUpdate(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		response.sendRedirect("board?action=reviewPage");
	}
	...
	private void doReviewPage(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		request.setAttribute("list", service.getList());
		request.getRequestDispatcher("/board/reviewPage.jsp").forward(request, response);
	}
